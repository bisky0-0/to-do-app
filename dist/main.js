...
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage */ "./src/dateSections/storage.js");
...
function today() {
    (0,_storage__WEBPACK_IMPORTED_MODULE_1__.deleteTask)((0,_storage__WEBPACK_IMPORTED_MODULE_1__.setArrayData)('AlltasksArray'))
    let currentDate = new Date();
    ...
    (0,_home__WEBPACK_IMPORTED_MODULE_0__.addTask)();
    //svg icon
    ...
    todayDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(currentDate, 'iii-LLL-dd');

    (0,_home__WEBPACK_IMPORTED_MODULE_0__.taskGenerator)(todayTasks, 'section', 'today');
    // deleteTask()
    console.log((0,_storage__WEBPACK_IMPORTED_MODULE_1__.setArrayData)('AlltasksArray'))
...
/* harmony import */ var _dateSections_today__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dateSections/today */ "./src/dateSections/today.js");
/* harmony import */ var _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dateSections/storage.js */ "./src/dateSections/storage.js");
...
function tasksPage() {
    ...
    _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setData()
    ...
    for (let i = 0; i < tagsArray.length; i++) {
        ...
        tagBtn.addEventListener('click', function () {
            _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.deleteTask((0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('AlltasksArray'))
    ...
    addTask()
    todayTasks.addEventListener('click', _dateSections_today__WEBPACK_IMPORTED_MODULE_1__.today);
...
function projectGenerator() {
    let loclstrgProjects = _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData('projectsArray')

    if (!localStorage.getItem("projectsArray")) {
        projectsArray.push(new _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.TemplateProject(`./icons/briefcase-solid.svg`, 'work', 'work', `Don’t let yesterday take up too much of today. Use work template now!`))
        projectsArray.push(new _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.TemplateProject(`./icons/phone-solid.svg`, 'calls', 'home', `Arrange your phone calls so you don't forget any of them`))
        _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.populateData('projectsArray', projectsArray)
        loclstrgProjects = _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData('projectsArray')
    }
...
function addTask() {
    ...
    //projects list
    let projectStorage = (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('projectsArray')
    ...
    function addTaskFun(e) {
        if (taskTitle.checkValidity() && taskDate.checkValidity()) {
            e.preventDefault();
            let currentWeek = (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.weekCalc)()
            let currentDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currentDate, "yyyy-LL-dd")
            let allArray = (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('AlltasksArray')

            function checkLocalStorage(newTask) {
                if (localStorage.getItem('AlltasksArray')) {
                    allArray.push(newTask);
                    (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.populateData)("AlltasksArray", allArray);
                }
                else {
                    _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.AlltasksArray.push(newTask)
                    ;(0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.populateData)("AlltasksArray", _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.AlltasksArray)
                }
            }

            if (taskDate.value == currentDay) {
                console.log('today')
                let newTask = new _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.Task(taskTitle.value, taskDate.value, ['all tasks', 'today', 'this week'], taskProject.value, taskTag.value, taskNote.value, false, false, false);
                checkLocalStorage(newTask)
                console.log((0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('AlltasksArray'))
            }


            else if (currentWeek.includes(taskDate.value)) {
                console.log('this week')
                let newTask = new _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.Task(taskTitle.value, taskDate.value, ['all tasks', 'this week'], taskProject.value, taskTag.value, taskNote.value, false, false, false)
                checkLocalStorage(newTask)
                ...
                console.log('all')
                let newTask = new _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.Task(taskTitle.value, taskDate.value, ['all tasks'], taskProject.value, taskTag.value, taskNote.value, false, false)
                checkLocalStorage(newTask)
                console.log((0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('AlltasksArray'))
            }
...
function taskGenerator(container, prop, condetion) {
    console.log('hello')
    let localStorageArray = (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.setArrayData)('AlltasksArray')
    ...
    allArray.forEach(element => {
        ...
        if (element[prop].includes(condetion) || element[prop] == condetion) {
            ...
            checkIcon.addEventListener('click', function () {
                (0,_dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.taskDone)(element, `AlltasksArray`, allArray)
                element.done == true ? task.classList.add('task-done') : task.classList.remove('task-done')
            });
            ...
            editBtn.addEventListener('click', function (e) {
                ...
                _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.editTask(allArray, element, props)
            })
            //I put it here not in delete in delet btn, to update array after it's generated
        }
    });

    _dateSections_storage__WEBPACK_IMPORTED_MODULE_2__.deleteTask(allArray)
...
let templatesArray = [new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/bath-solid.svg`, 'Personal hygiene', 'home', `If you don't smell good, then you don't look good`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/book-open-reader-solid.svg`, 'reading', 'hobbies', `Carry your book(s) everywhere. There's always an opportunity to read`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/briefcase-solid.svg`, 'work', 'work', `Don’t let yesterday take up too much of today. Use work template now!`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/building-columns-solid.svg`, 'financial tasks', 'personal activities', `Manage your financial tasks today. Time has value in your money`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/cart-shopping-solid.svg`, 'shopping', 'home', 'This template helps you not to forget the things you need to buy. Try it now!'),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/children-solid.svg`, 'family', 'home', `Spend more time with your family, it helps you feel better about everything`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/dumbbell-solid.svg`, 'fitness', 'personal activities', 'Stay healthy by adding your favorite exercises to your daily to-do list.'),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/graduation-cap-solid.svg`, 'studying', 'education', `Studying is one of your top priorities today. Organize your time for it now`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/handshake-solid.svg`, 'meetings', 'work', `Take care of your interviews and organize your ideas for them before you begin. to make the best impression`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/heart-pulse-solid.svg`, 'health', 'personnal activities', `the perfect mind in healthy body. Put your healthy steps into your tasks today`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/heart-solid.svg`, 'your relations', 'personnal activities', `Your relationships in life have an impact on your daily productivity. Try to make it better`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/money-bill-trend-up-solid.svg`, 'investments', 'personal activities', `Arrange your investment times according to the market to get the highest profit and the safest decisions`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/palette-solid.svg`, 'art', 'hobbies', `Give time to your imagination to be creative and add beauty to your day`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/person-walking-solid.svg`, 'sports', 'hobbies', 'Start your day with exercise to get the energy needed to perform your other tasks'),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/phone-solid.svg`, 'calls', 'home', `Arrange your phone calls so you don't forget any of them`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/plane-solid.svg`, 'travel', 'hobbies', `Arrange your trips according to your time and work`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/seedling-solid.svg`, 'planting', 'home', `Green gives you inspiration. Take care of your plants now`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/utensils-solid.svg`, 'cooking', 'home', `Make your own meals to be healthier. I believe your food tastes great`),
new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(`./icons/volleyball-solid.svg`, 'sports', 'hobbies', `Playing sports daily helps you to be in good health and a better condition`),
]
...
function templatesSection() {
    ...
    for (let i = 0; i < templatesArray.length; i++) {
        ...
        templateCard.addEventListener('click', function () {
            ...
            document.body.textContent = '';
            projectsArray.push(new _dateSections_storage__WEBPACK_IMPORTED_MODULE_1__.TemplateProject(templatesArray[i].icon, templatesArray[i].name, templatesArray[i].category, templatesArray[i].discription))
